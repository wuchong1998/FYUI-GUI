...
namespace FYUI {
	...
	class FYUI_API CVirListBodyUI : public CListBodyUI
	{
	public:
	...
	protected:
		...
		* @return 无
		*/
		void SetPosInternally(RECT rc, int cxRequired);
		...
		* @return 无
		*/
		virtual void OnKeyDown(wchar_t ch) {}
		...
		* @return 无
		*/
		virtual void OnKeyUp(wchar_t ch) {}
	...
	public:
		...
		*/
		bool GetSelectIndex(std::vector<int>& vec);
	...
	private:
		...
		RECT m_HorRect = {0, 0, 0, 0};  // 横向滚动时候记录 横向滚动的位置 
	};
};
