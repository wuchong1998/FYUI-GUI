...
namespace FYUI 
{
	CControlFactory::CControlFactory()
	{
		...
		INNER_REGISTER_DUICONTROL(CButtonExUI);
		INNER_REGISTER_DUICONTROL(CFrameTestUI);
		...
		INNER_REGISTER_DUICONTROL(CWebpAnimUI);
		...
		INNER_REGISTER_DUICONTROL_EX(L"XList", CListExUI);
		INNER_REGISTER_DUICONTROL_EX(L"ListTextExElement", CListTextExtElementUI);

		INNER_REGISTER_DUICONTROL(CFadeButtonUI);
		INNER_REGISTER_DUICONTROL(CRingUI);

		INNER_REGISTER_DUICONTROL(CCountdownUI);
	...
	CControlUI* CControlFactory::CreateControl(std::wstring strClassName)
	{
