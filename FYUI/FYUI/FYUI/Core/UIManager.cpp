...
namespace FYUI {
	...
	bool CPaintManagerUI::MessageHandler(UINT uMsg, WPARAM wParam, LPARAM lParam, LRESULT& lRes)
	{
		...
		break;
		case UIMSG_SCROLL_ANIMATE:
		{
			auto* pContainer = reinterpret_cast<CContainerUI*>(wParam);
			if (pContainer != nullptr && pContainer->GetManager() == this) {
				pContainer->HandleWheelAnimationFrameMessage();
			}
			return true;
		}
		case WM_CLOSE:
