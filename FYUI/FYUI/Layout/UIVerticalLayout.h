...
namespace FYUI
{
	...
	public:
		/**
		 * @brief 构造 CVerticalLayoutUI 对象
		 * @details 用于构造 CVerticalLayoutUI 对象。具体行为由当前对象状态以及传入参数共同决定。
		 */
		CVerticalLayoutUI();
		...
		/**
		 * @brief 设置分隔高度
		 * @details 用于设置分隔高度。具体行为由当前对象状态以及传入参数共同决定。
		 * @param iHeight [in] 高度值
		 */
		void SetSepHeight(int iHeight);
		/**
		 * @brief 获取分隔高度
		 * @details 用于获取分隔高度。具体行为由当前对象状态以及传入参数共同决定。
